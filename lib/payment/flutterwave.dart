...
class SalonPay extends StatefulWidget {
  const SalonPay({key});

  @override
  State<SalonPay> createState() => SalonPayState();
}

class SalonPayState extends State<SalonPay> {
  ...
  Future<void> _makepayment(
    ...
    try {
      Flutterwave flutterwave = Flutterwave.forUIPayment(
          ...
          encryptionKey: "FLWSECK_TEST200d7af70c85",
          publicKey: "FLWPUBK_TEST-bc2bf63c7be43f4208971d6a74142e48-X",
          currency: "ugx",
          amount: amount,
          email: email,
          fullName: "Aisha",
